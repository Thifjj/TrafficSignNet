...
`DOCUMENTACAO_COMPLETA.md` contém a documentação em português de todo o
projeto, incluindo quantização, compilação e interpretação dos resultados.

## Copy one archive to the board

On the host, copy the generated archive:

```bash
scp zcu104_inference.tar.gz root@ZCU104_IP:/home/root/
```
